        ...
        <div className="score-breakdown">
          ...
          {finalScore && (
            <div className="breakdown-card">
              {gameState?.gameMode === 'randomProduct' ? (
                ...
                <>
                  ...
                  <div className="breakdown-row highlight">
                    ...
                    <span className="value positive">${(finalScore as any).setsValue.toFixed(2)}</span>
                  </div>

                  <div className="breakdown-row">
                    <span className="label">Leftover Ingredients (scrap)</span>
                    <span className="value">${(finalScore as any).scrapValue.toFixed(2)}</span>
                  </div>
